...
export default defineConfig({
	tasks: [
		...
		// jobs are now separate tasks). No lighthouse config referenced here
		// even though lighthouse-config is one of the packages — this repo
		// doesn't run Lighthouse against itself.
