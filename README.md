...
| [`@theholocron/tsconfig`](packages/tsconfig) | TypeScript base configs (NextJS, Node, Node 22) | [![npm](https://img.shields.io/npm/v/@theholocron/tsconfig)](https://www.npmjs.com/package/@theholocron/tsconfig) |
